...
class NewController extends Controller
{
    ...
    //Transaction Logs
           ...
           public function RegisterForm()
        {
            ...
            return view('user.newprofile.registeration');
        }
           public function RegisterFormDetails(Request $request)
        {
                ...
                $data = array('Name'=>$request->name,
                        ...
                        // print_r($data);die('nor');
                         ...
                         $result = DB::table('curd')->insert($data); 
                       if($result)
                        {
                             return redirect('user/register_form')->with('success', 'You have been registered successfully');
                        }else{
