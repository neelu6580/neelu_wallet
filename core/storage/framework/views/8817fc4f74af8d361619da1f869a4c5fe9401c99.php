          ...
          <tbody>  
            <?php $__currentLoopData = $virtualCardsOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$OrderDetails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <tr>
                  ...
                  <td><?php echo e($OrderDetails->created_qty); ?> / <?php echo e($planDetails->plan_quantity); ?>  <?php echo e(__('Cards')); ?></td>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/greenvx4/public_html/vcard/core/resources/views/user/instantissue/vcard_orders.blade.php ENDPATH**/ ?>