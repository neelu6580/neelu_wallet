     ...
     Step 3 > Create Physical/Digital Products
            ...
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              <h1 class="text-dark">
                ...
                <?php else: ?>
                  <?php echo e(__('Mobile verification')); ?>
                    ...
                    <div class="modal-body p-0">
                      <div class="card border-0 mb-0">
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            <a href="<?php echo e($_SERVER['REQUEST_URI']); ?>" class="btn btn-primary" id="resend_otp_button_idd" style="display:none">Resend OTP Now</a>
...
<?php echo $__env->make('loginlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/greenvx4/public_html/vcard/core/resources/views/user/profile/verify.blade.php ENDPATH**/ ?>