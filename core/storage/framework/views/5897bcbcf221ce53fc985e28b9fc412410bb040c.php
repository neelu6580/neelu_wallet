            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.settlement.update')); ?>" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input type="number" name="duration" pattern="[0-9]+(\.[0-9]{0,2})?%?" value="<?php echo e($set->virtual_card_min_amt); ?>" id="duration" class="form-control" placeholder="1" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label col-lg-2"><?php echo e(__('Card Max Amount')); ?></label>
                        <div class="col-lg-10">
                            <input type="number" name="duration" pattern="[0-9]+(\.[0-9]{0,2})?%?" value="<?php echo e($set->virtual_card_max_amt); ?>" id="duration" class="form-control" placeholder="1" required>
                        </div>
                    </div>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/greenvx4/public_html/vcard/core/resources/views/admin/settings/index.blade.php ENDPATH**/ ?>