                        ...
                        <table class="table table-flush" id="datatable-buttons">
                            ...
                            <?php $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php $vendorData = DB::table('users')->where('id',$val->user_id)->first();?> <?php if(!empty($vendorData)): ?><?php echo e($vendorData->first_name); ?><?php else: ?><?php echo e('NA'); ?><?php endif; ?> </td>
                                    ...
                                    <td>
                                        <?php if($val->active==1): ?>
                                            <span class="badge badge-pill badge-success"><?php echo e(__('No')); ?></span>
                                        <?php else: ?>
                                            <span class="badge badge-pill badge-danger"><?php echo e(__('Yes')); ?></span>
                                        <?php endif; ?>
                                    </td>                                      
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/greenvx4/public_html/vcard/core/resources/views/admin/transfer/product.blade.php ENDPATH**/ ?>