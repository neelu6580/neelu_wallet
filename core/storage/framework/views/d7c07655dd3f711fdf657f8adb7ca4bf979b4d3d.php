    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card bg-white">
          <div class="card-body">
            <div class="">
              <h3 class="">International Bank Transfer</h3>
              <!--<p class="mt-0 mb-5">Transfer charge is <?php echo e($set->transfer_chargex); ?>% per transaction.</p>-->
              <p class="mt-0 mb-5">International Bank Transfer charges: 3%- 5% ( Subject to Beneficiary Bank Location).</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <form action="<?php echo e(route('submit.otherbank')); ?>" method="post" id="modal-details">
            <?php echo csrf_field(); ?>
                ...
                <div class="form-group row">
                  <label class="col-form-label col-lg-2">Select Country</label>
                  <div class="col-lg-10">
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/core/resources/views/user/transfermoney/other_bank.blade.php ENDPATH**/ ?>