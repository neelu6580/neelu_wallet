...
<div class="container-fluid mt--6">
  <div class="content-wrapper">
    ...
    <?php $__currentLoopData = $virtualCardsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=> $c_list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="carousel-item <?php if($k == 0): ?><?php echo e('active'); ?><?php endif; ?>">
           
        <div class="card-body"> 
          <h3><?php echo e($c_list->memo); ?> Card Details</h3>
            <div class="card">
            <!-- Card body -->
           <a href="<?php echo e(url('user/virtualcard')); ?>">
            <div class="card-body2<?php echo e($c_list->design_id); ?>">
              <div class="row justify-content-between align-items-center">
                <div class="col">
                  <!--<span class="text-primary h6 surtitle ">$0.00</span>  -->
                <span class="badge badge-pill badge-success"><?php if($c_list->card_state == 'OPEN'): ?><?php echo e('Active'); ?><?php elseif($c_list->card_state == 'CLOSED'): ?><?php echo e('CLOSED'); ?><?php else: ?><?php echo e('Inactive'); ?><?php endif; ?></span>               
                  </div>
                
              </div>             
              <div class="my-4">
                <span class="h6 surtitle text-gray mb-2" style="    color: #ffffff !important;">
               <?php echo e($c_list->host_name); ?>

                </span>
                <div class="text-primary" data-toggle="modal" data-target="#modal-more15" style="cursor: pointer;">
                  <div  style="color: #ffffff !important;">XXXX XXXX XXXX   <?php echo e($c_list->last_four_digit); ?></div>
                </div>
              </div>
              <div class="row">               
                <div class="col-6">
    ...
    font-size: 13px;color: #ffffff !important;"><?php echo e($currency->symbol); ?><?php echo e($c_list->restAmount); ?> / <span class="text-gray" style="color: #ffffff !important;"><?php echo e($currency->symbol); ?><?php echo e($c_list->spend_limit); ?></span></span>
                </div>
    ...
    <?php echo e(__('Recent Card Transactions')); ?>
    ...
    <tbody>
        ...
        ?>
        <?php if(count($AllTransactionsList) > 0): ?>
       ...
       <tr>
           <td><?php echo e(++$k); ?></td>
           <td><td><?php echo e($currency->symbol.number_format($TransactionsDetails->amount/100)); ?> / <?php echo e($currency->symbol.number_format($TransactionsDetails->card->spend_limit/100)); ?></td></td>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/greenvx4/public_html/vcard/core/resources/views/user/newdashboard/index.blade.php ENDPATH**/ ?>