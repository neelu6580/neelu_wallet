            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><?php echo e(__('Settlements')); ?></h3>
                    </div>
                        ...
                        <table class="table table-flush" id="datatable-buttons">
                            ...
                            <?php $__currentLoopData = $withdraw; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if($val->status==0): ?>
                                            <span class="badge badge-pill badge-danger"><?php echo e(__('Unpaid')); ?></span>
                                        <?php elseif($val->status==1): ?>
                                            <span class="badge badge-pill badge-success"><?php echo e(__('Paid')); ?></span> 
                                        <?php elseif($val->status==2): ?>
                                            <span class="badge badge-pill badge-info"><?php echo e(__('Declined')); ?></span>
                                        <?php endif; ?>
                                    </td> 
                                    <td><?php echo e($val->dbank['name']); ?></td>
                                    <td><?php echo e($val->dbank['acct_no']); ?></td>
                                    <td><?php echo e($val->dbank['acct_name']); ?></td>
                                        ...
                                        <div class="">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    ...
                                                    <?php if($val->status==0): ?>
                                                        <a class='dropdown-item' href="<?php echo e(route('withdraw.decline', ['id' => $val->id])); ?>"><?php echo e(__('Decline')); ?></a>
                                                        <a class='dropdown-item' href="<?php echo e(route('withdraw.approve', ['id' => $val->id])); ?>"><?php echo e(__('Approve')); ?></a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div> 
                                            ...
                                            <div class="modal-body p-0">
                                                <div class="card bg-white border-0 mb-0">
                                                    ...
                                                    <div class="card-body px-lg-5 py-lg-5 text-right">
                                                        ...
                                                        <a  href="<?php echo e(route('withdraw.delete', ['id' => $val->id])); ?>" class="btn btn-danger btn-sm"><?php echo e(__('Proceed')); ?></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/boompay/core/resources/views/admin/withdrawal/index.blade.php ENDPATH**/ ?>