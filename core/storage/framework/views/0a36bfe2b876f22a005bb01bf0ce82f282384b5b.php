...
.form-error-msg{
              ...
              <li><button class="btn active login-btn " data-toggle="tab" href="#phonetab">Login By Phone</button></li>
              <p style="text-align:center;    margin-bottom: 5px;
    margin-top: 5px;">Or</p>
              <li><button class="btn btn2 login-btn " data-toggle="tab" href="#emailtab">Login By Email</button></li>
            </ul>
            
            <div class="tab-content">
             
              <div id="phonetab" class="tab-pane fade in active show" style="    background: #f7fafc;">
