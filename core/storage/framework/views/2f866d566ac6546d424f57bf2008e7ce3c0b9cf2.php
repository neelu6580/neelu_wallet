...
.card-body2{width: 60%;margin: 9px auto; padding: 0.5rem 1rem;
background: #34c4f8;    font-size: 14px;
    border-radius: 8px;
    flex: 1 1 auto;}
.card-body1
{    
  ...
  <div class="content-wrapper">
    <div class="row align-items-center py-4">
      <div class="col-lg-6 col-5">
        <?php if(count($create_limit_checked) < 1 && Auth::user()->user_type == 1): ?>      
            <a data-toggle="modal" data-target="#modal-formx" href="" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> Create Card</a>
        <?php elseif(count($create_limit_checked) < 3 && Auth::user()->user_type == 2): ?> 
         <a data-toggle="modal" data-target="#modal-formx" href="" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> Create Card</a>
        <?php else: ?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-12">
                        <div class="input-group">
                          ...
                          <input type="number" name="card_limit" class="form-control" min="<?php echo e($set->virtual_card_min_amt); ?>" max="<?php echo e($set->virtual_card_max_amt); ?>" placeholder="Card extend limit e.i 100" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" required>
