      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav mb-md-3"> 
            ...
            <?php endif; ?>
          <li class="nav-item">
              <a class="nav-link <?php if(route('admin.virtual_cards')==url()->current() || route('admin.virtual_cards_transactions')==url()->current() || route('admin.deposit.log')==url()->current()): ?> active <?php endif; ?>" href="#card7676" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples">
                <i class="fa fa-bookmark-o"></i>
              ...
              <div class="collapse <?php if(route('admin.virtual_cards')==url()->current() || route('admin.virtual_cards_transactions')==url()->current() || route('admin.deposit.log')==url()->current()): ?> show <?php endif; ?>" id="card7676">
                <ul class="nav nav-sm flex-column">
