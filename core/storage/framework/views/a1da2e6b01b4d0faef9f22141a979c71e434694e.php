      ...
      <div class="header-body text-center mb-7">
        <div class="row justify-content-center">
          <div class="col-xl-5 col-lg-6 col-md-8 px-5">
            <h3 class="text-white"><?php echo e($link->name); ?></h3> <span class="text-white">By <?php echo e($merchant->first_name); ?></span>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="row justify-content-center">
            <div class="col-lg-3 order-lg-2">
              <div class="card-profile-image">
                <img src="<?php echo e(url('/')); ?>/asset/images/logo_1604661746.png" class="rounded-circle border-secondary" style="border-radius:0%!important;margin-top: 23px;">
              </div>
            </div>
          </div>
...
<h5>Program Type :	Instant Issue General Purpose Reloadable</h5>
       <li>Quantity : <?php echo e($planDetails->plan_quantity); ?> <?php echo e(__('Cards')); ?> </li>
...
<br>
            ...
            <form role="form" action="<?php echo e(route('send.vcard.single')); ?>" method="post" id="modal-details">
                            ...
                            <div class="card-body">
                              <form action="<?php echo e(route('send.single')); ?>" role="form" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="<?php echo e($stripe->val1); ?>" id="payment-form">
                                ...
                                <div class="text-center">
                                  <button type="submit" class="btn-block btn-success btn-sm" form="modal-details" style="font-size: 16px;"><?php echo e(__('Pay Now')); ?> <span id="cardresult"></span></button><br>
              ...
              <div class="text-center">
                <button type="button" data-toggle="modal" data-target="#fund" class="btn-block btn-success my-4" style="font-size:17px;border-radius:4px;padding:5px"><?php echo e(__('Pay Now')); ?></button>
              </div>
              <div class="text-center">
...
<?php echo $__env->make('paymentlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/greenvx4/public_html/vcard/core/resources/views/user/link/vcard_sc_view.blade.php ENDPATH**/ ?>