...
<div class="main-content">
    ...
    <div class="progress-bar2" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width:33%">
      <span class="sr-only">0% Complete</span>
     Step 4 > Create Physical/Digital Products
    </div>
  </div>
              ...
              <form role="form" action="{{route('submitregister')}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-7">
                          <div class="input-group input-group-alternative">
                            ...
                            <input class="form-control" placeholder="{{__('Phone Number')}}" type="text" name="phone" required>
                          </div>
                        </div>
                    </div>
                  </div>
                ...
                <div class="form-group mb-3">
                  ...
                  @if ($errors->has('business_name'))
                    <span class="error form-error-msg ">{{$errors->first('business_name')}}</span>
                  @endif
                </div>                                              
                 ...
                 <div class="form-group">
                   ...
                   <div class="col-lg-12">
                    ...
                    <select class="form-control" name="source_from">
                      ...
                      @if ($errors->has('source_from'))
                        <span class="error form-error-msg ">{{ $errors->first('source_from') }}</span>
                      @endif
                      </div>
                      </div>
                </div>
