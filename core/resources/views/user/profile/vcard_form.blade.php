  ...
  <div class="content-wrapper">
    <div class="row">
      ...
      <!-- neelu form-->
              ...
              <form action="{{route('user.vcard_profile')}}" method="post" enctype="multipart/form-data">
              @csrf
            ...
            <input type="file" name="picture" class="form-control" placeholder="Insert picture">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-8">
                  <input type="email" name="neelu_email" class="form-control" placeholder="Neelu Email" value="{{$user->neelu_email}}">    
                </div>
              </div>                
              <div class="form-group row">
                <label class="col-form-label col-lg-4">{{__('Neelu password')}}</label>
                <div class="col-lg-8">
                  <input type="text" name="neelu_password" class="form-control" placeholder="Neelu Password" value="{{$user->neelu_password}}">    
                </div>
              </div>                
                         ...
                         <tr>
                             ...
                             <td>
                                 ...
                                 @if(empty($user->picture))
                                  <img src="{{url('asset/profile/user-default.png')}}" width ="50" heigth="50">
                                 @else
                                 <img src="{{url('asset/profile/')}}/{{$user->picture}}" width ="50" heigth="50" alt ="alt.jpg" >
                                 @endif
                                 
                             </td>
                             <td>{{ $user->neelu_email }}</td>
                            <td>{{ $user->neelu_password }}</td>
                            <td>
                                <a href="{{url('user/vcard_editprofile')}}/{{$user->id}}" class="btn btn-primary">Edit</a>&nbsp;
						        <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#myModal{{$user->id}}">Delete</a>&nbsp;
      ...
      <div class="modal-content">
       ...
       <center><div> <h4 class="modal-title">Are you sure want to delete?</h4>
        ...
        <div class="modal-footer">
            <a href="{{url('user/vcard_delete')}}/{{$user->id}}" class="btn btn-success" >YES</a>
