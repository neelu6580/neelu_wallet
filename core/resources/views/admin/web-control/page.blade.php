    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12">
                ...
                <a  href="{{route('page.add')}}" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> {{__('Create Page')}}</a>
                </div>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    ...
                                                    <a class='dropdown-item' href="{{route('page.edit', ['id' => $val->id])}}">{{ __('Edit')}}</a>
