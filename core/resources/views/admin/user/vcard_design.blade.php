...
@foreach($virtualCardsDesign as $k => $productDetails)
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">{{__('List of All Card Design')}}</h3>
                        
                    </div>
 <div class="row"> 
 @foreach($virtualCardsDesign as $k => $designDetails)
    <div class="col-md-4">
        <div class="card">
           
          <div class="card-body"> 
          <h3>{{$designDetails->design_name}}</h3>
            <div class="card">
            <!-- Card body -->
            ...
            <div class="card-body{{$designDetails->id}}">
              <div class="row justify-content-between align-items-center">
                <div class="col">
                 ...
                 @if($designDetails->status== 0)
                                            <span class="badge badge-pill badge-danger">{{__('Inactive')}}</span>
                                        @elseif($designDetails->status== 1)
                                            <span class="badge badge-pill badge-success">{{__('Active')}}</span>
                                        @elseif($designDetails->status== 2)
              ...
              <div class="my-4">
                ...
                <div class="text-primary" data-toggle="modal" data-target="#editDesign{{$designDetails->id}}" style="cursor: pointer;">
    ...
    font-size: 13px;color: #ffffff !important;">$20.00 / <span class="text-gray" style="color: #ffffff !important;">$1000</span></span>
      ...
      <div class="modal fade" id="editDesign{{$designDetails->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
                                            ...
                                            <div class="modal-body p-0">
                                                <div class="card bg-white border-0 mb-0">
                                                    <div class="card-header">
                                                      ...
                                                      <form action="{{route('admin.edit_virtual_card_design')}}" method="POST">
                                                        @csrf
                                                       <input type="hidden" name="design_id" value="{{$designDetails->id}}">
                                                        <div class="row p-3">
                                                            <div class="col-sm-3">
                                                                {{__('Name')}}</label>
                                                            </div>
                                                             <div class="col-sm-9">
                                                                 <input class="form-control" type="text" name="design_name" placeholder="Enter Card Type Name" value="{{$designDetails->design_name}}" required>
                                                            </div>
                                                        </div>
                                                        <div class="row p-3">
                                                            <div class="col-sm-3">
                                                             ...
                                                             <div class="col-sm-9">
                                                                 <select class="form-control" name="status">
                                                                     <option value="1" @if($designDetails->status == 1){{'selected'}} @endif>Active</option>
                                                                     <option value="0" @if($designDetails->status == 0){{'selected'}} @endif>Inactive</option>
                                                                </select>     
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row p-3">
                                                            <div class="col-sm-3">
                                                             ...
                                                             <div class="col-sm-9">
                                                                 <textarea class="form-control" type="text" name="description" placeholder="Enter Description"  required>{{$designDetails->description}}</textarea>
                                                            </div>
                                                        </div>
                                ...
                                <div class="modal fade" id="delete{{$designDetails->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
                                            ...
                                            <div class="modal-body p-0">
                                                <div class="card bg-white border-0 mb-0">
                                                    ...
                                                    <div class="card-body px-lg-5 py-lg-5 text-right">
                                                        ...
                                                        <a  href="{{route('admin.delete_virtual_card_design', ['id' => $designDetails->id])}}" class="btn btn-danger btn-sm">{{__('Proceed')}}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="modal-body p-0">
                                                <div class="card bg-white border-0 mb-0">
                                                    <div class="card-header">
                                                      ...
                                                      <form action="{{route('admin.add_virtual_card_design')}}" method="POST">
                                                        @csrf
